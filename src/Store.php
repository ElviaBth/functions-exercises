...
class Store
{
    ...
    //Escribe tu código aquí...
    public function rateByPrice($price){
        return $price <= 50 ? "€" : $price > 50 and $price <= 100 ? "€€" : "€€€";
    }
    ...
    //Escribe tu código aquí...
    public function randomItem($maxnum){
        $myarray = range(0,$maxnum);
        $result = array_rand($myarray,3);
        return $result;
    }
    ...
    //Escribe tu código aquí...
    public function getItem($my_array, $max_price){
        $result = array_filter($my_array, fn($item_price) => $item_price <= $max_price);
        return $result;
    }
}
